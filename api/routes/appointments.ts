...
import { db, appointmentsTable } from "../../src/server/db";
import { eq, desc, count } from "drizzle-orm";
import { CreateAppointmentBody, UpdateAppointmentBody, ListAppointmentsQueryParams } from "../../src/server/validation";
